...
import { FrameRate as FR } from 'ad-events'
import { ImageManager } from 'ad-control'

function SpritePlayer(arg) {
  // using FrameRate singleton
	const FrameRate = new FR()
		...
		*/
		loop: {
			...
			set: function(value) {
				...
				console.log('loop:', value, isLoop, _loopTotal)
	...
	*/
	...
	function checkComplete() {
		if (_frame == _total - 1) {
			console.log(_loopCount, _loopTotal)
