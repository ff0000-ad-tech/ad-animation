/**
	...
	@desc
		<a href="https://github.com/ff0000-ad-tech/ad-animation">Github repo</a>
		<br><br>
...
function SpritePlayer(arg) {
	...
	if (arg.target instanceof HTMLCanvasElement) {
		...
		Styles.setCss(S, { width: canvasW, height: canvasH })
		if (align) Align.set(S, align)
	}
	...
	Object.defineProperties(S, {
		...
		*/
		...
		/**	
			...
			@var {number} endframe
			@desc
				A number representing the endframe.
			@example
	...
	*/
	...
	function checkComplete() {
		if (_frame == _endFrame) {
			if (!S.loop || _loopCount >= _loopTotal) {
				S.pause()
				S.onComplete.call(S)
	...
	if (arg.endFrame > -1 && arg.endFrame < _endFrame) {
		S.endFrame = arg.endFrame
	}
