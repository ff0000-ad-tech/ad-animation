...
export default class TweenPromise {
	 ...
	 * @param time
	 * 	The time on the tween
	 * @param vars
	 * 	All options {@see greensock}
	 * @property thenParams
	 * 	Optional property of the <code>vars</code> object: values to be passed through <code>.then()</code>
	 * 	as an Array.
	 ...
	 * 	All options {@see greensock}
	 * @property thenParams
	 * 	Optional property of the <code>toVars</code> object: values to be passed through <code>.then()</code>
	 * 	as an Array.
